...
`)+`
`+u);const y=A+p+a,E=A+u+o,U=fo(s,s.VERTEX_SHADER,y),b=fo(s,s.FRAGMENT_SHADER,E);s.attachShader(_,U),s.attachShader(_,b),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function w(C){if(i.debug.checkShaderErrors){const V=s.getProgramInfoLog(_).trim(),G=s.getShaderInfoLog(U).trim(),X=s.getShaderInfoLog(b).trim();let j=!0,W=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,U,b);else{const J=mo(s,U,"vertex"),H=mo(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
